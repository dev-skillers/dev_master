<?php
header( "refresh:15;url=paymentscod.php" );
...
//sponsor bonus code
$ref_query11s=mysqli_query($con,"SELECT  * FROM affiliateuser WHERE username='$ref'");
$ref_list11s=$ref_query11s->fetch_array(MYSQLI_ASSOC);
$refs=$ref_list11s['referedby'];
$tot_marketer_earnings=$ref_list11s['tamount'];
...
$sponsor_bonus=$row211['indirect_ref_amt'];
$tot_amt_20=$tot_marketer_earnings+$sponsor_bonus;
$query=mysqli_query($con,"update affiliateuser set tamount='".$tot_amt_20."'where username='".$ref."'");

//sponsor bonus code ends here
...
if($c1_count==0)
{
	...
	for ($i=1; $i <=100 ; $i++) { 
		$marketer_count *=$downline; // $marketer_count=2*2
		
		
		if($ref_count<=$marketer_count){  //3>=4
	...
	*/
	...
	if($ref_under_count<2)
	{
		...
		$tot_amt=($row4['TotalAmt']); 
		
		$query=mysqli_query($con,"update affiliateuser set level='".$ref_stage."' where username='".$ref."'");
		...
		/*for($i=2;$i<=100;$i++){
		 if($all_list1['stage'.$i.'_ref']!=NULL){
		 	$level_bonus_stagevise=$row211['level'.$i];	
		...
		while($ref_bonus_user !=""){
			...
			if($ref_bonus_user2 !=""){
				...
				//stage level bonus code starts here
				$query5lvl=mysqli_query($con,"SELECT  * FROM affiliateuser WHERE username = '$ref_bonus_user2'");
				$row5lvl=$query5lvl->fetch_array(MYSQLI_ASSOC);
				$curr_stagelvl=$row5lvl['level']; 
				$curr_packlvl=$row5lvl['pcktaken'];//current package for stage1 ref
				$sqlquery_packagelvl="SELECT * FROM packages where id = $curr_packlvl"; //fetching amt from package table from database
				$package_detailslvl=mysqli_query($con,$sqlquery_packagelvl);
				$package_infolvl = $package_detailslvl->fetch_array(MYSQLI_ASSOC);
				$indirect_ref_amtlvl=$package_infolvl['indirect_ref_amt'];
				//$stage_level_bonus=$package_infolvl['level'.$curr_stagelvl];
				$stage_level_bonus=$row211['level'.$i];
				//$tot_amt2=($qrow2['TotalAmt']+$stage_level_bonus);//check here karthik stage level bonus should vary
				$tot_amt2=($qrow2['TotalAmt']);			
				//stage level bonus code ends here
		...
		for($i=1;$i<=100;$i++){
			$ref_bonus_user4=$all_list1['stage'.$i.'_ref']; 
			

			 if(($ref_bonus_user4 !=NULL && $ref_bonus_user4!="")&& $i<=100){
				
				$qq2=mysqli_query($con,"SELECT  tamount As TotalAmt FROM affiliateuser WHERE username = '$ref_bonus_user4'");
				$qrow2=$qq2->fetch_array(MYSQLI_ASSOC);
				$stage_level_bonus=$row211['level'.$i];
				$tot_amt222=($qrow2['TotalAmt']+$stage_level_bonus);//check here karthik stage level bonus should vary
				
				/* code by karthikeyan starts (20-02-2017) added pcktaken to below query */
				$downline_sql1=mysqli_query($con,"SELECT pcktaken,COUNT(referedby) As TotalDownline FROM affiliateuser WHERE referedby = '$ref_bonus_user4'");
				$downline_row1=$downline_sql1->fetch_array(MYSQLI_ASSOC);
				$tot_downline1=$downline_row1['TotalDownline'];
				/* code by karthikeyan starts (20-02-2017) */
				$bonus_user_pack=$downline_row1['pcktaken'];
				...
				//while ($earning_row1 = mysqli_fetch_array($earning_sql1, MYSQL_ASSOC)) {
					...
					//if (($tot_downline1 >= $earning_row1['downline_count']) && ($tot_amt2 <= $earning_row1['earning_amt'])){
						...
						//echo "<br/>";
						//check and and apply here
						$qupdate2=mysqli_query($con,"update affiliateuser set tamount='".$tot_amt222."' where username='".$ref_bonus_user4."'");	
						//$downline_matched =true;
						
						//echo "update affiliateuser set tamount='".$tot_amt2."' where username='".$ref_bonus_user4."'";
						//$st_update2=mysqli_query($con,"update affiliate_bonus_history set stage".$i."_ref='".$ref_bonus_user2."'where user_id='".$luser_id."'");		
					//}
				//}
	...
	elseif($ref_under_count>=2){
	 ...
	 //    exit;
		...
		//code added 24/08/2017 for count check
		//getting stage count
	$s1=mysqli_query($con,"SELECT  COUNT(*) as STAGE1TOTUSER FROM affiliateuser as a,affiliate_bonus_history as b
	 WHERE (b.stage1_ref = '$stage1_ref' || b.stage2_ref = '$stage1_ref' || b.stage3_ref = '$stage1_ref' || b.stage4_ref = '$stage1_ref' || b.stage5_ref = '$stage1_ref' || b.stage6_ref = '$stage1_ref' || b.stage7_ref = '$stage1_ref' || b.stage8_ref = '$stage1_ref' || b.stage9_ref = '$stage1_ref' || b.stage10_ref = '$stage1_ref' || b.stage11_ref = '$stage1_ref' || b.stage12_ref = '$stage1_ref' || b.stage13_ref = '$stage1_ref' || b.stage14_ref = '$stage1_ref' || b.stage15_ref = '$stage1_ref' || b.stage16_ref = '$stage1_ref' || b.stage17_ref = '$stage1_ref' || b.stage18_ref = '$stage1_ref' || b.stage19_ref = '$stage1_ref' || b.stage20_ref = '$stage1_ref' || b.stage21_ref = '$stage1_ref' || b.stage22_ref = '$stage1_ref' || b.stage23_ref = '$stage1_ref' || b.stage24_ref = '$stage1_ref' || b.stage25_ref = '$stage1_ref' || b.stage26_ref = '$stage1_ref' || b.stage27_ref = '$stage1_ref' || b.stage28_ref = '$stage1_ref' || b.stage29_ref = '$stage1_ref' || b.stage30_ref = '$stage1_ref' || b.stage31_ref = '$stage1_ref' || b.stage32_ref = '$stage1_ref' || b.stage33_ref = '$stage1_ref' || b.stage34_ref = '$stage1_ref' || b.stage35_ref = '$stage1_ref' || b.stage36_ref = '$stage1_ref' || b.stage37_ref = '$stage1_ref' || b.stage38_ref = '$stage1_ref' || b.stage39_ref = '$stage1_ref' || b.stage40_ref = '$stage1_ref' || b.stage41_ref = '$stage1_ref' || b.stage42_ref = '$stage1_ref' || b.stage43_ref = '$stage1_ref' || b.stage44_ref = '$stage1_ref' || b.stage45_ref = '$stage1_ref' || b.stage46_ref = '$stage1_ref' || b.stage47_ref = '$stage1_ref' || b.stage48_ref = '$stage1_ref' || b.stage49_ref = '$stage1_ref' || b.stage50_ref = '$stage1_ref' || b.stage51_ref = '$stage1_ref' || b.stage52_ref = '$stage1_ref' || b.stage53_ref = '$stage1_ref' || b.stage54_ref = '$stage1_ref' || b.stage55_ref = '$stage1_ref' || b.stage56_ref = '$stage1_ref' || b.stage57_ref = '$stage1_ref' || b.stage58_ref = '$stage1_ref' || b.stage59_ref = '$stage1_ref' || b.stage60_ref = '$stage1_ref' || b.stage61_ref = '$stage1_ref' || b.stage62_ref = '$stage1_ref' || b.stage63_ref = '$stage1_ref' || b.stage64_ref = '$stage1_ref' || b.stage65_ref = '$stage1_ref' || b.stage66_ref = '$stage1_ref' || b.stage67_ref = '$stage1_ref' || b.stage68_ref = '$stage1_ref' || b.stage69_ref = '$stage1_ref' || b.stage70_ref = '$stage1_ref' || b.stage71_ref = '$stage1_ref' || b.stage72_ref = '$stage1_ref' || b.stage73_ref = '$stage1_ref' || b.stage74_ref = '$stage1_ref' || b.stage75_ref = '$stage1_ref' || b.stage76_ref = '$stage1_ref' || b.stage77_ref = '$stage1_ref' || b.stage78_ref = '$stage1_ref' || b.stage79_ref = '$stage1_ref' || b.stage80_ref = '$stage1_ref' || b.stage81_ref = '$stage1_ref' || b.stage82_ref = '$stage1_ref' || b.stage83_ref = '$stage1_ref' || b.stage84_ref = '$stage1_ref' || b.stage85_ref = '$stage1_ref' || b.stage86_ref = '$stage1_ref' || b.stage87_ref = '$stage1_ref' || b.stage88_ref = '$stage1_ref' || b.stage89_ref = '$stage1_ref' || b.stage90_ref = '$stage1_ref' || b.stage91_ref = '$stage1_ref' || b.stage92_ref = '$stage1_ref' || b.stage93_ref = '$stage1_ref' || b.stage94_ref = '$stage1_ref' || b.stage95_ref = '$stage1_ref' || b.stage96_ref = '$stage1_ref' || b.stage97_ref = '$stage1_ref' || b.stage98_ref = '$stage1_ref' || b.stage99_ref = '$stage1_ref' || b.stage100_ref = '$stage1_ref') AND (a.username = b.user_id )");
	$stage1_list=$s1->fetch_array(MYSQLI_ASSOC);
	$stage1_count=$stage1_list['STAGE1TOTUSER'];
	//getting stage count ends
	 $ref_count= $stage1_count;  
	...
	for ($i=1; $i <=100 ; $i++) { 
		...
		$row4=$query4->fetch_array(MYSQLI_ASSOC);
		$tot_amt=($row4['TotalAmt']);
		//$tot_amt=($row4['TotalAmt']+($sponsor_bonus+$stage_amt)); //sponsor bonus + stage level bonus
		
		
		$query=mysqli_query($con,"update affiliateuser set level='".$ref_stage."' where username='".$stage1_ref."'");
	...
	//upgradation process code ends 
		...
		while($ref_bonus_user !=""){
			...
			if($ref_bonus_user2 !=""){
				...
				$indirect_ref_amtlvl=$package_infolvl['indirect_ref_amt'];
				$ref_bonus_user2;
				//$stage_level_bonus=$package_infolvl['level'.$curr_stagelvl]; //hided by sridhar
				//$stage_level_bonus=$package_infolvl['level'.$i]; //check here karthik stage level bonus should vary
				$stage_level_bonus=$row211['level'.$i];
				$tot_amt2=($qrow2['TotalAmt']+$stage_level_bonus);
				//echo "update affiliateuser set tamount='".$tot_amt2."'where username='".$ref_bonus_user2."'";
				//exit;			
				//stage level bonus code ends here
		...
		//$i=2;
			...
			for($i=1;$i<=100;$i++){
			$ref_bonus_user3=$all_list1['stage'.$i.'_ref'];
			$stage_level_bonus=$row211['level'.$i];
			//echo "next-".$ref_bonus_user3.":-".$stage_level_bonus; echo"</br>";

			 if(($ref_bonus_user3!=NULL && $ref_bonus_user3!="")  && $i<=100){
				
				$qq2=mysqli_query($con,"SELECT  tamount As TotalAmt FROM affiliateuser WHERE username = '$ref_bonus_user3'");
				$qrow2=$qq2->fetch_array(MYSQLI_ASSOC);
				
				$tot_amt2=($qrow2['TotalAmt']+$stage_level_bonus);//check here karthik stage level bonus should vary
				
				/* code by karthikeyan starts (20-02-2017) added pcktaken to below query */
				$downline_sql1=mysqli_query($con,"SELECT pcktaken,COUNT(referedby) As TotalDownline FROM affiliateuser WHERE referedby = '$ref_bonus_user3'");
				$downline_row1=$downline_sql1->fetch_array(MYSQLI_ASSOC);
				$tot_downline1=$downline_row1['TotalDownline'];
				/* code by karthikeyan starts (20-02-2017) */
				$bonus_user_pack=$downline_row1['pcktaken'];
				...
				//while ($earning_row1 = mysqli_fetch_array($earning_sql1, MYSQL_ASSOC)) {
					...
					//if (($tot_downline1 >= $earning_row1['downline_count']) && ($tot_amt2 <= $earning_row1['earning_amt'])){
						...
						//echo "<br/>";
						//check and and apply here
						$qupdate2=mysqli_query($con,"update affiliateuser set tamount='".$tot_amt2."' where username='".$ref_bonus_user3."'");
						
						//echo 	"update affiliateuser set tamount='".$tot_amt2."' where username='".$ref_bonus_user3."'"; echo "<br/>";
						//$downline_matched =true;
...
if($result){
echo "<center>Profile Activated<br/>Redirecting in 15 seconds...</center>";
}
else
{
echo "<center>Action could not be performed, Something went wrong. Check back again<br/>Redirecting in 15 seconds...</center>";
}